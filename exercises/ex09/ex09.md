...
children seem to inherit the heap and globals from the parent, but do not seem to share them with eachother or save their state on exit. They do share the same code segments though.
