...
It is a collection of libraries that implement common data structures and other elements in c.
It appears to be used quite broadly for all kinds of things.
The name is literally so confusing that I still don't know what it means.

*  What are the most important pros and cons of using GLib, as opposed
to another library, or just using core C features?

GLib is really good at providing a lot of easy to use features, but it is not as customizable as straight c and depends on a lot of things.

*  What do you have to do to compile and run a "Hello GLib" example?

1. Go through like 20 pages of confusing guides on how to install it.

2. $ cc hello.c `pkg-config --cflags --libs glib-2.0` -o hello
