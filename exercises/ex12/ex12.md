...
No, the value is super wrong most of the time.

Threads are able to read and write the counters concurrently and they get very
messed up.
...
Tons of synchronization errors occur and the counts are all messed up.
...
Takes about twice as long in this case
